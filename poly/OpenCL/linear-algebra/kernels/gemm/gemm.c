...
int get_global_id(int){return 0;}
  ...
  void gemm( DATA_TYPE *a,  DATA_TYPE *b,  DATA_TYPE *c, DATA_TYPE alpha, DATA_TYPE beta, int ni, int nj, int nk) 
{
	STATIC_BEGIN("GEMM_kernel", (), ())
