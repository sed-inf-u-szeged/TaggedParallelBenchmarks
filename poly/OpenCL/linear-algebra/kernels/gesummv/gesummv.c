...
int main(int argc, char *argv[])
{
    ...
    DYNAMIC_BEGIN("GESUMMV_init")
	read_cl_file(argv[3]);
	cl_initialization(platDev.platformId, platDev.deviceId);
    DYNAMIC_END

    DYNAMIC_BEGIN("GESUMMV_xfer_to")
    ...
    DYNAMIC_BEGIN("GESUMMV_xfer_from")
...
int get_global_id(int){return 0;}
 ...
 void gesummv_kernel( DATA_TYPE *a,  DATA_TYPE *b,  DATA_TYPE *x,  DATA_TYPE *y,  DATA_TYPE *tmp, DATA_TYPE alpha, DATA_TYPE beta, int n) 
{    
STATIC_BEGIN("GESUMMV_kernel", (), ())
