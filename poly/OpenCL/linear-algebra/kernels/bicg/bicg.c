...
void bicgKernel1( DATA_TYPE *A,  DATA_TYPE *p,  DATA_TYPE *q, int nx, int ny) 
{
	STATIC_BEGIN("BICG_kernel_1", (), ())
...
void bicgKernel2( DATA_TYPE *A,  DATA_TYPE *r,  DATA_TYPE *s, int nx, int ny) 
{
	STATIC_BEGIN("BICG_kernel_2", (), ())
